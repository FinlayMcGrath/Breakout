// TriangleMesh.cpp
// Triangle mesh, for example purposes.
...
void TriangleMesh::InitBuffers(ID3D11Device* device)
{
	...
	m_vertices[0].position = XMFLOAT3(0.0f, 1.0f, 0.0f);  // Top.
	m_vertices[0].texture = XMFLOAT2(0.0f, 1.0f);
	m_vertices[0].normal = XMFLOAT3(0.0f, 0.0f, -1.0f);

	m_vertices[1].position = XMFLOAT3(-1.0f, 0.0f, 0.0f);  // Bottom left.
	m_vertices[1].texture = XMFLOAT2(0.0f, 0.0f);
	m_vertices[1].normal = XMFLOAT3(0.0f, 0.0f, -1.0f);

	m_vertices[2].position = XMFLOAT3(1.0f, 0.0f, 0.0f);  // Bottom right.
