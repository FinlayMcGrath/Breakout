...
void BaseShader::loadVertexShader(WCHAR* filename)
{
	...
	result = D3DCompileFromFile(filename, NULL, NULL, "main", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, &vertexShaderBuffer, &errorMessage);
	if (FAILED(result))
	{
